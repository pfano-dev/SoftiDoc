  ...
  return (
      <main>
          <header className="head">
              <h1><span className="span">Softi</span>Doc Meeting App</h1>
          ...
          <div className="add-btn row items-center content-center" >
              <div className="btn add" onClick={() => openModal("new-modal")}><span className="create-span">Create Meeting</span> +</div>
      </div>
      ...
      {
        dataList.length === 0 ?
          <div className="row mt-15 waiting">No item</div> :
